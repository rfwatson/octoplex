...
const file_domain_proto_rawDesc = "" +
	"\n" +
	"\fdomain.proto\x12\x03api\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfd\x03\n" +
	"\tContainer\x12\x0e\n" +
	...
	"_exit_code\"\xff\x01\n" +
	"\x06Source\x12,\n" +
	"\tcontainer\x18\x01 \x01(\v2\x0e.api.ContainerR\tcontainer\x12\x12\n" +
	...
	"\trtmps_url\x18\a \x01(\tR\brtmpsUrl\"\xe6\x01\n" +
	"\vDestination\x12,\n" +
	"\tcontainer\x18\x01 \x01(\v2\x0e.api.ContainerR\tcontainer\x12/\n" +
	"\x06status\x18\x02 \x01(\x0e2\x17.api.Destination.StatusR\x06status\x12\x0e\n" +
	...
	"\x04date\x18\x04 \x01(\tR\x04date\"\x94\x01\n" +
	"\bAppState\x12#\n" +
	"\x06source\x18\x01 \x01(\v2\v.api.SourceR\x06source\x124\n" +
	"\fdestinations\x18\x02 \x03(\v2\x10.api.DestinationR\fdestinations\x12-\n" +
	"\n" +
	"build_info\x18\x03 \x01(\v2\x0e.api.BuildInfoR\tbuildInfoB5Z3git.netflux.io/rob/octoplex/internal/generated/grpcb\x06proto3"
