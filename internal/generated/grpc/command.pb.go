...
const file_command_proto_rawDesc = "" +
	"\n" +
	"\rcommand.proto\x12\x03api\"\xbd\x05\n" +
	"\aCommand\x12K\n" +
	"\x11list_destinations\x18\x01 \x01(\v2\x1c.api.ListDestinationsCommandH\x00R\x10listDestinations\x12E\n" +
	"\x0fadd_destination\x18\x02 \x01(\v2\x1a.api.AddDestinationCommandH\x00R\x0eaddDestination\x12N\n" +
	"\x12update_destination\x18\x03 \x01(\v2\x1d.api.UpdateDestinationCommandH\x00R\x11updateDestination\x12N\n" +
	"\x12remove_destination\x18\x04 \x01(\v2\x1d.api.RemoveDestinationCommandH\x00R\x11removeDestination\x12K\n" +
	"\x11start_destination\x18\x05 \x01(\v2\x1c.api.StartDestinationCommandH\x00R\x10startDestination\x12H\n" +
	"\x10stop_destination\x18\x06 \x01(\v2\x1b.api.StopDestinationCommandH\x00R\x0fstopDestination\x12U\n" +
	"\x15close_other_instances\x18\a \x01(\v2\x1f.api.CloseOtherInstancesCommandH\x00R\x13closeOtherInstances\x129\n" +
	"\vkill_server\x18\b \x01(\v2\x16.api.KillServerCommandH\x00R\n" +
	"killServer\x12E\n" +
	"\x0fstart_handshake\x18\t \x01(\v2\x1a.api.StartHandshakeCommandH\x00R\x0estartHandshakeB\x0e\n" +
	"\fcommand_type\"\x19\n" +
	...
	"\x15StartHandshakeCommandB5Z3git.netflux.io/rob/octoplex/internal/generated/grpcb\x06proto3"
